...
class FrameBufferRender {
  ...
  fun initEGLContext(): Boolean {
    ...
    val context = EGL14.eglCreateContext(
      display, config[0], EGL14.EGL_NO_CONTEXT,
      ctxAttr, 0
    )
  ...
  fun draw(width: Int, height: Int): Bitmap {
    ...
    GLES30.glBufferData(
      GLES30.GL_ARRAY_BUFFER, vertex.size * 4,
    ...
    try {
      ...
      Matrix.orthoM(
        proj, 0, 0f, width.toFloat(), 0f,
        height.toFloat(), -1f, 100f
      )
      GLES30.glUniformMatrix4fv(matrixLocation, 1, false, proj, 0)
      ...
      GLES30.glReadPixels(
        0, 0, width, height, GLES30.GL_RGBA,
